        ...
        <>
            ...
            <div className="viewport">
                ...
                <div className="viewport-top">
                    ...
                    <header className="site-head" style={{ ...site.cover_image && { backgroundImage: `url(${site.coverImage.childImageSharp.fluid.src})` } }}>
                        <div className="container">
                            ...
                            {isHome ?
                                ...
                                null}
                            <nav className={`site-nav ${!isHome ? `site-nav-pages` : ``}`}>
    ...
    <StaticQuery
        query={graphql`
            query {
                ...
                logo: file(relativePath: {eq: "Navigatecode5.png"}) {
                    childImageSharp {
                        fixed(width: 233, height: 70){
